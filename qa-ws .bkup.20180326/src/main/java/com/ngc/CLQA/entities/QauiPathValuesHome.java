...
public class QauiPathValuesHome {
	...
	private static final Logger log = LogManager.getLogger(QauiPathValuesHome.class);
	...
	public QauiPathValues merge(QauiPathValues detachedInstance) {
		...
		try {
			QauiPathValues result = (QauiPathValues) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public QauiPathValues findById(java.math.BigDecimal id) {
		...
		try {
			QauiPathValues instance = (QauiPathValues) sessionFactory.getCurrentSession().get("QauiPathValues", id);
			if (instance == null) {
	...
	public List findByExample(QauiPathValues instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("QauiPathValues")
