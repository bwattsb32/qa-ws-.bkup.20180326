...
public class QauiSectionsHome {
	...
	private static final Logger log = LogManager.getLogger(QauiSectionsHome.class);
	...
	public QauiSections merge(QauiSections detachedInstance) {
		...
		try {
			QauiSections result = (QauiSections) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public QauiSections findById(java.math.BigDecimal id) {
		...
		try {
			QauiSections instance = (QauiSections) sessionFactory.getCurrentSession().get("QauiSections", id);
			if (instance == null) {
	...
	public List findByExample(QauiSections instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("QauiSections")
