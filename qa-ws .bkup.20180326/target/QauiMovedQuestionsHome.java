...
public class QauiMovedQuestionsHome {
    ...
    private static final Log log = LogFactory.getLog(QauiMovedQuestionsHome.class);
    ...
    public QauiMovedQuestions merge(QauiMovedQuestions detachedInstance) {
        ...
        try {
            QauiMovedQuestions result = (QauiMovedQuestions) sessionFactory.getCurrentSession()
    ...
    public List findByExample(QauiMovedQuestions instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("QauiMovedQuestions")
