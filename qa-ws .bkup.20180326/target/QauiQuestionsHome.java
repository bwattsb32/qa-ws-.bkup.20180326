...
public class QauiQuestionsHome {
    ...
    private static final Log log = LogFactory.getLog(QauiQuestionsHome.class);
    ...
    public QauiQuestions merge(QauiQuestions detachedInstance) {
        ...
        try {
            QauiQuestions result = (QauiQuestions) sessionFactory.getCurrentSession()
    ...
    public QauiQuestions findById( java.math.BigDecimal id) {
        ...
        try {
            QauiQuestions instance = (QauiQuestions) sessionFactory.getCurrentSession()
                    .get("QauiQuestions", id);
            if (instance==null) {
