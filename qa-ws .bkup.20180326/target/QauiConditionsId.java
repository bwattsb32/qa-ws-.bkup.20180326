...
public class QauiConditionsId  implements java.io.Serializable {
    ...
    public QauiConditionsId(String conditionDbid, String conditionText, String documentId, String isAnswerOrQuestion, String referenceDbid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof QauiConditionsId) ) return false;
		 QauiConditionsId castOther = ( QauiConditionsId ) other; 
         
		 return ( (this.getConditionDbid()==castOther.getConditionDbid()) || ( this.getConditionDbid()!=null && castOther.getConditionDbid()!=null && this.getConditionDbid().equals(castOther.getConditionDbid()) ) )
 && ( (this.getConditionText()==castOther.getConditionText()) || ( this.getConditionText()!=null && castOther.getConditionText()!=null && this.getConditionText().equals(castOther.getConditionText()) ) )
 ...
 && ( (this.getIsAnswerOrQuestion()==castOther.getIsAnswerOrQuestion()) || ( this.getIsAnswerOrQuestion()!=null && castOther.getIsAnswerOrQuestion()!=null && this.getIsAnswerOrQuestion().equals(castOther.getIsAnswerOrQuestion()) ) )
 && ( (this.getReferenceDbid()==castOther.getReferenceDbid()) || ( this.getReferenceDbid()!=null && castOther.getReferenceDbid()!=null && this.getReferenceDbid().equals(castOther.getReferenceDbid()) ) );
   }
