...
public class QauiAnswersHome {
    ...
    private static final Log log = LogFactory.getLog(QauiAnswersHome.class);
    ...
    public QauiAnswers merge(QauiAnswers detachedInstance) {
        ...
        try {
            QauiAnswers result = (QauiAnswers) sessionFactory.getCurrentSession()
    ...
    public QauiAnswers findById( java.math.BigDecimal id) {
        ...
        try {
            QauiAnswers instance = (QauiAnswers) sessionFactory.getCurrentSession()
                    .get("QauiAnswers", id);
            if (instance==null) {
