...
public class QauiConditionsHome {
    ...
    private static final Log log = LogFactory.getLog(QauiConditionsHome.class);
    ...
    public QauiConditions merge(QauiConditions detachedInstance) {
        ...
        try {
            QauiConditions result = (QauiConditions) sessionFactory.getCurrentSession()
    ...
    public QauiConditions findById( QauiConditionsId id) {
        ...
        try {
            QauiConditions instance = (QauiConditions) sessionFactory.getCurrentSession()
                    .get("QauiConditions", id);
            if (instance==null) {
