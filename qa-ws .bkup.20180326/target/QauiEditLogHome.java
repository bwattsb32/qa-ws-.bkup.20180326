...
public class QauiEditLogHome {
    ...
    private static final Log log = LogFactory.getLog(QauiEditLogHome.class);
    ...
    public QauiEditLog merge(QauiEditLog detachedInstance) {
        ...
        try {
            QauiEditLog result = (QauiEditLog) sessionFactory.getCurrentSession()
    ...
    public QauiEditLog findById( java.math.BigDecimal id) {
        ...
        try {
            QauiEditLog instance = (QauiEditLog) sessionFactory.getCurrentSession()
                    .get("QauiEditLog", id);
            if (instance==null) {
